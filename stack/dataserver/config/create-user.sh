...
echo "INSERT INTO libraries VALUES ('${5}', 'user', '0000-00-00 00:00:00', '0', '1', '0')" | $MYSQL zotero_master
...
echo "INSERT INTO shardLibraries VALUES ('${5}', 'user', '0000-00-00 00:00:00', '0', '0')" | $MYSQL zotero_shard_1
