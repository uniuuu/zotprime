...
echo "INSERT INTO users VALUES (1, 1, '${ADMIN_USERNAME}')" | $MYSQL zotero_master
...
echo "INSERT INTO users (userID, username, password) VALUES (1, '${ADMIN_USERNAME}', MD5('${ADMIN_PASSWORD}'))" | $MYSQL zotero_www
echo "INSERT INTO users_email (userID, email) VALUES (1, '${ADMIN_EMAIL}')" | $MYSQL zotero_www
echo "ALTER TABLE users AUTO_INCREMENT = 2" | $MYSQL zotero_www
