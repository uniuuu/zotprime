...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/users/{id}/quota-info', [UserController::class, 'getQuota'])->name('users.quotaInfo');
    ...
    Route::post('/items/publish', [ItemController::class, 'publish'])->name('items.publish');
});
